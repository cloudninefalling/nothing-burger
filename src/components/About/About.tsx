export default function About() {
  return (
    <section className="flex w-3/5 flex-col gap-2">
      <div className="flex flex-auto flex-col items-center  rounded-2xl bg-color-primary px-8 py-8 text-color-text shadow-[inset_0_0px_6px_rgba(0,0,0,0.3)]">
      ...
      <p className="flex-auto rounded-2xl bg-color-primary px-8 py-8 text-center text-3xl  text-color-text shadow-[inset_0_0px_6px_rgba(0,0,0,0.3)]">
